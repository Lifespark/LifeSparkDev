...
namespace LS {
    ...
    public class Region : MonoBehaviour {
        ...
        public void PrepareRegionPolygon() {
            ...
            new Vector3(regionPoints[0].transform.position.x, /*this.gameObject.transform.position.y + */0.5f, regionPoints[0].transform.position.z),
            new Vector3(regionPoints[1].transform.position.x, /*this.gameObject.transform.position.y + */0.5f, regionPoints[1].transform.position.z),
            new Vector3(regionPoints[2].transform.position.x, /*this.gameObject.transform.position.y + */0.5f, regionPoints[2].transform.position.z)
        };
