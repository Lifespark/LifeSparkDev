...
public class TriggerAudioOneShot : TickEvent
{
	[ObjectTemplate]
	...
	public override void Process(Action _action, Track _track)
	{
		...
		if(mutilSource)
		{
			AudioSource audioComp = targetObject.audio;
			...
			audioComp.PlayOneShot (clipLoaded);
		}
		else
		{
			if(targetObject.audio == null)
			...
			targetObject.audio.PlayOneShot(clipLoaded);
		}
	}
